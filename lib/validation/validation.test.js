...
test('null readableLength', testInvalidConfig, assign({}, validConfig, { readableLength: null }), '"readableLength" must be a number')
test('none-numeric readableLength', testInvalidConfig, assign({}, validConfig, { readableLength: 'hello' }), '"readableLength" must be a number')
test('missing readableLength', testInvalidConfig, omit(validConfig, 'readableLength'), '"readableLength" is required')
